...
<table class="form-layout-compressed" style="width:80%">
  {include file="SCH/Form/Family/FormatCheckboxes.tpl" fieldName=race otherName=race_other}
  {include file="SCH/Form/Family/FormatCheckboxes.tpl" fieldName=race_hispanic otherName=race_hispanic_other}
  {include file="SCH/Form/Family/FormatCheckboxes.tpl" fieldName=race_asian otherName=race_asian_other}
  {include file="SCH/Form/Family/FormatCheckboxes.tpl" fieldName=race_family_structure otherName=''}
</table>
</fieldset>
