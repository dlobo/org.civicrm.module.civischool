...
if (theme_get_setting('sfschool_classic_fixed')) {
  drupal_add_css(path_to_theme() . '/sfschool-fixed.css', 'theme', 'all');
}
 ...
 */
function sfschool_classic_theme(&$existing, $type, $theme, $path) {
  return sfschool_theme($existing, $type, $theme, $path);
}
